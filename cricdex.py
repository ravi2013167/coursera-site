...
from cricdb_setup import Player, Team, Base, Batsman, Bowler, Fielder, PlayerStrength, PlayerWeakness, PlayerMoment, Video
...
@app.route('/index/<int:team_id>/')
@app.route('/index/<int:team_id>/players/')
def showPlayers(team_id):
    ...
    if 'username' not in login_session or creator.id != login_session['user_id']:
        return render_template('playerlist.html', players=players, team=team)
